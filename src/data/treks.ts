const treks = {
  ...
  tulail_gangabal_naranag_trek: {
    ...
    introduction: [
      "Gurez-Tulail Gangabal Trek expedition is a crossover trek from Tulail in Gurez Valley to Naranag in Sind Valley crossing Zajibal Pass (4080 m). Mount Eco is the only local agency that lead a maiden and successful Trek-Expedition of Levison Wood’s Walking the Himalayas through this hidden valley of Kashmir in 2015 summer. Being the organizers of the trek, acquiring trek-permits was the most challenging part of the trek; as the base camp lies close to the Line of Control. Mount Eco started an era opening this trek for many to come.",
